*** Settings ***
Library     Browser
Library     ${CURDIR}/unittest_my_robot_func.py
...
Test Case GroupTagA 1.1
    [Tags]      GroupingTagA    My Tag      Another Tag     UNIT-TEST
    Sleep       4
    Log         Hello World!

Test Case GroupTagA 1.2
    [Tags]          Another Tag     Very Nice Tag        GroupingTagA       UNIT-TEST
    Open ToDo App
...
Test Case Not In Output XML 1
    [Tags]          Completely Different Tag        UNIT-TEST
    ${rand_num}     Random Num
